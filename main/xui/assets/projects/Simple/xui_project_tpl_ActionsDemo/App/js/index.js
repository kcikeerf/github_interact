xui.Class('App', 'xui.Module',{
    Instance:{
        ...
        iniComponents : function(){
            ...
            host.ctl_group2.append(
                ...
                },
                {
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["Hi","You closed alert dialog"],
                    "method":"message"
                }])
                );
            ...
            host.ctl_group2.append(
                ...
                .onClick([{
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["Title","Continuew to exec?"],
                    "method":"confirm",
                    "onOK":2
                },
                {
            ...
            host.ctl_group2.append(
                ...
                .onClick([{
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["Title","Continuew to exec?","text"],
                    "method":"prompt",
                    "onOK":3,
                    "onKO":4
                },
                ...
                },
                {
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["You clicked cancel","cancel"],
                    "method":"message",
                    "conditions":[{
                        "left":"{temp.koData}",
                        "symbol":"=",
            ...
            host.ctl_group21.append(
                ...
                },
                {
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["'aa dd cc' doesn't contain 'bb'"],
                    "method":"pop",
                    "conditions":[{
                        "left":"aa dd cc",
                        "symbol":"exclude",
                ...
                },
                {
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["'aa dd cc' starts with 'aa'"],
                    "method":"pop",
                    "conditions":[{
                        "left":"aa dd cc",
                        "symbol":"start",
            ...
            host.ctl_group21.append(
                ...
                .onHotKeydown([{
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["Key:{args.1.key}<br/>\nCtrl:{args.1.ctrlKey}<br/>\nShift:{args.1.shiftKey}<br/>\nAlt:{args.1.altKey}","Keyboard Event",200,5000],
                    "method":"message",
                    "conditions":[{
                        "left":"",
                        "symbol":"=",
            ...
            host.ctl_pane39.append(
                ...
                .beforeClose([{
                    ...
                    "type":"other",
                    "target":"msg",
                    "params":["Cancel before event","Close Event was cancelled!"],
                    "method":"pop",
                    "return":false
                }])
                );
            ...
            host.ctl_pane39.append(
                ...
                .setWidth("334px")
                .setHeight("47px")
                .setCaption("Actions without code")
                .setCustomStyle({
                    "KEY":{
                        "color":"#4B0082",
        ...
        events:{"onRender":[{"desc":"message", "type":"other", "target":"msg", "params":["This is in conf!", "Page on render"], "scope":null, "method":"message"}, "_com_onrender"]},
        _com_onrender:function (com, threadid){
            xui.asyRun(function(){
                xui.message("Page on render","This is in code!");
            },3000);
        }
    },
    Static:{
