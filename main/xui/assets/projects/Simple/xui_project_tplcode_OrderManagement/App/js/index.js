xui.Class('App', 'xui.Module',{
    Instance:{
        ...
        iniComponents:function(){
            ...
            host.block3.append(
                ...
                .setItems([{
                    "id" : "a",
                    "caption" : "Task",
                    "tips" : "Task - Orders - Customers",
                    "image" : "{/}img/module.gif"
                },{
                    "id" : "b",
                    "caption" : "Set up",
                    "tips" : "item b",
            ...
            host.stacks1.append(
                ...
                .setWidth(130)
                .setHeight(100)
                .setHtml("<font color=\"red\">All copy right reserved<br><br></font><div><font color=\"red\">xxx.com</font><div><font color=\"red\"><br>2012-2014</font></div></div>")
                , "c");
            ...
            host.dialog7.append(
                (new xui.UI.Block())
                .setHost(host,"ctl_block112")
                .setDock("top")
                .setHeight(28)
                .setOverflow("hidden")
            );

            host.ctl_block112.append(
                (new xui.UI.PageBar())
                ...
                .setWidth(360)
                .setHeight(22)
                .setCaption("Click No To See Orders")
                .setValue("1:1:3")
            ...
            host.dialog14.append(
                (new xui.UI.Block())
                .setHost(host,"ctl_block132")
                .setDock("top")
                .setHeight(28)
                .setOverflow("hidden")
            );

            host.ctl_block132.append(
                (new xui.UI.PageBar())
        ...
        _load1:function(key){
            ...
            xui.request('{/}Data/Orders.js',null,ns._ajax1_onrequestok);
        },  
        ...
        _load2:function(key){
            if(SPA.global_data_customer){
                ...
                var ns=this;
                xui.request('{/}Data/Customers.js',null,ns._ajax2_onrequestok);
            }
        },
