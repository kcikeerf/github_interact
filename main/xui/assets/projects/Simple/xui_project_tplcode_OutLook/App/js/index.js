        ...
        iniComponents:function(){
            ...
            host.pnlNote.append(
                ...
                .setItems([{
                    "id" : "a",
                    "caption" : "Meeting..",
                    "tips" : "Meeting with Mr. Lincon",
                    "image" : "{/}img/notice.gif"
                },{
                    "id" : "b",
                    "caption" : "1:1 talk",
                    "tips" : "1:1 talk with Mr. Terry",
                    "image" : "{/}img/notice.gif"
                },{
                    "id" : "c",
                    "caption" : "Interview",
                    "tips" : "Interview with BCC",
                    "image" : "{/}img/notice.gif"
                }])
                .setDock("fill")
                .setItemPadding("4")
            ...
            host.panelbar4.append(
                ...
                .setItems([{
                    ...
                    "id" : "b",
                    "caption" : "<font color=red><b>Inbox(6)</b></font>",
                    "tips" : "incoming messages go here",
                    "image" : "{/}img/allinone.gif",
                    "imagePos" : "-16px top"
                },{
                    "id" : "c",
                    "caption" : "Outbox",
                    "tips" : "Sent items go here",
                    "image" : "{/}img/allinone.gif",
                    "imagePos" : "-112px top"
                }])
                .setValue("")
            ...
            host.group1.append(
                ...
                .setItems([{
                    "id" : "a",
                    "caption" : "Show note images",
                    "tips" : "Show note images"
                },{
                    "id" : "b",
                    "caption" : "Notes List",
                    "tips" : "Show notes within a list"
                },{
                    "id" : "c",
                    "caption" : "Other",
                    "tips" : "Other"
            ...
            append(
                ...
                .setItems([{
                    ...
                    "sub" : [{
                        "id" : "toolNewMail",
                        "caption" : "New Mail",
                        "tips" : "New Mail Message",
                        "image" : "{/}img/allinone.gif",
                        "imagePos" : "-80px top"
                    }],
                    "caption" : "toolSection1"
                },{
                    "id" : "toolSection2",
                    "sub" : [{
                        "id" : "toolPrint",
            ...
            append(
                ...
                .setItems([{
                    ...
                    "sub" : [{
                        ...
                        "caption" : "New",
                        "sub" : [{
                            "id" : "menFileNewMailMessage",
                            "caption" : "Main Message",
                            "image" : "{/}img/allinone.gif",
                            "imagePos" : "-80px top"
                        },{
                            "id" : "menFileNewAppointment",
                            "caption" : "Appointment",
                            "image" : "{/}img/allinone.gif",
                            "imagePos" : "-256px top"
                        }]
                        ...
                        "id" : "menFileDataFile",
                        "caption" : "Data File Management..."
                    },{
                        "id" : "menFileClose",
                        "caption" : "Close All Items"
                    },{
                        "id" : "menFileExport",
                        "caption" : "Export and import"
                    },{
                        "id" : "menFileWorkOffline",
