...
Aws.config.update({
  credentials: Aws::Credentials.new(
    'AKIAIS5JBWHSP4XBXHNA',
    'Kl1Q93vrsJKxhzpYq5PCw9MQfILHwE67FPzl/w2I'
    ),
  region: "us-east-2"
})
...
Dynamoid.configure do |config|
  ...
  config.namespace = "xui" # To namespace tables created by Dynamoid from other tables you might have. Set to nil to avoid namespacing.
